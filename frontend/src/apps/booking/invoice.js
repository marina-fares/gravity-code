...
const today = new Date()
	...
	<PageHeader title={shift.branch_name} />
		...
		<hr style={{ margin: '10px' }} />
		<PaperRow right='Total' right_bold={true} left={`E£${(shift.total_price/100)}.00`} left_bold={true} />
		
		{(shift.first_paid !== "") && 
		<PaperRow right={`${shift.first_paid_method}`} right_bold={true} left={`E£${shift.first_paid}.00`} left_bold={true} />
