...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 50,
    # By default DRF serialises DecimalField as strings ("100.00") to avoid
    # JSON floating-point rounding. Setting this to False returns actual
    # JSON numbers (100.00) so the frontend can use them directly without
    # calling parseFloat() on every monetary field.
